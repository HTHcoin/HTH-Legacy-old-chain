...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
	    ...
	    case SPORK_15_LAST_MN_BLK:			    r = SPORK_15_LAST_MN_BLK_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
	...
	case SPORK_15_LAST_MN_BLK:			return SPORK_15_LAST_MN_BLK_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_LAST_MN_BLK")			return SPORK_15_LAST_MN_BLK;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
	...
	case SPORK_15_LAST_MN_BLK:			return "SPORK_15_LAST_MN_BLK";
        default:
