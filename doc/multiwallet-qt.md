...
Only requiring some minor changes is reden.cpp.
...
Changes to reden.cpp
----------------------
reden.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
