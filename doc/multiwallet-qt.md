...
Only requiring some minor changes is hth.cpp.
...
Changes to hth.cpp
----------------------
hth.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
