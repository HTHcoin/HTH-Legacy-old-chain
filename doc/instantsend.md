...
This mechanism has been integrated into Bitcore-Node-HTH which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hthcoin/insight-api-hth#web-socket-api](https://github.com/hthcoin/insight-api-hth#web-socket-api) 
* API: [https://github.com/hthcoin/insight-api-hth#instantsend-transactions](https://github.com/hthcoin/insight-api-hth#instantsend-transactions) 
...
By default, the HTH Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the HTH Core daemon:
